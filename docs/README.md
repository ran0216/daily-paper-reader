...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-26 22:16:11 UTC<br>状态：成功</p>
</section>
...
<p>精读：《Balancing Generality and Specialization: A Survey on AI Datacenter Hardware Architecture》（8.0/10）</p>
<p>速读：《Circuit-Architecture-Training Co-Design with Regenerative-SA Similarity Sensing for Aggressive SAR Skipping in Analog Compute-in-Memory》（7.0/10）, 《Dynamic Slack-Aware Clocking for Near-Threshold Tensor Processing Units (TPUs)》（7.0/10）, 《Implementation and Evaluation of BitNet Inference on a CGLA by Signed-Int4 Instructions》（6.0/10）</p>
